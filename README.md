...
#### CLIENT : Prenotazione semaforo e scrittura del pid nella message queue <sup><sub>([reference code](https://github.com/Phil-Peret/ElaboratoSO/blob/fcdcf001792c6d8ee78a644a94a5a4543dd94108/F4Client.c#L189-L246))</sub></sup>
...
#### SERVER : Attesa in message queue di nuovi messaggi <sup><sub>([reference code](https://github.com/Phil-Peret/ElaboratoSO/blob/fcdcf001792c6d8ee78a644a94a5a4543dd94108/F4Server.c#L255-L284))</sub></sup>
...
### Gestione doppio <kbd>Ctrl</kbd>+<kbd>C</kbd> per terminazione server <sup><sub>([reference code](https://github.com/Phil-Peret/ElaboratoSO/blob/fcdcf001792c6d8ee78a644a94a5a4543dd94108/F4Server.c#L123-L168))</sub></sup>
...
### Client che gioca in modo automatico <sup><sub>([reference code](https://github.com/Phil-Peret/ElaboratoSO/blob/fcdcf001792c6d8ee78a644a94a5a4543dd94108/F4Server.c#L264-L267))</sub></sup>
...
### Gestione dei segnali durante la fork <sup><sub>([reference code]())</sub></sup>
